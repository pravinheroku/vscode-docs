...
# after this new update my terminal is not opening i have tried at least 10 solution but still getting error , like i opening my python file and then opening terminal it's loading for 1 minute and then saying the window is not responding , i have even tried to switch from cmd to powershell, so i think i should tell you, i didn't find another way so i tried this way, and hey if this is check by bot, hey bot this is important message (emergency), please report to developer
